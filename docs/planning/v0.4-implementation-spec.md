# Rackarr v0.2 Implementation Specification
...
│   └── migration.ts          # MODIFY: v0.3 → v0.2 migration
└── stores/
...
| ------------- | -------------------- | ---------- |
| v0.2 Folder   | `[name]/[name].yaml` | Read/Write |
...
/**
 * Migrate v0.1-0.3 layout to v0.2 format
 */
...
describe('migrateLayout', () => {
	it('migrates v0.3 layout to v0.2', () => {
