...
- [x] Write test: rack with default front view
- [x] Write test: rack with specified rear view
- [x] Update createRack() to accept view parameter
- [x] Default to DEFAULT_RACK_VIEW
- [x] Update layout store addRack action (if needed)
- [x] Fix any failing tests
- [x] All tests pass (717)
- [x] **Commit:** `feat(rack): add view property to rack creation`
...
| 2. Core Features        | 2.1-2.8 | 8/8 ✅       |
| 3. UI Polish            | 3.1-3.5 | 5/5 ✅       |
| 4. Data & Migration     | 4.1-4.4 | 4/4 ✅       |
| **TOTAL**               | **23**  | **23/23** ✅ |
